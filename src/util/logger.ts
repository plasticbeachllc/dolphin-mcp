...
function baseLine (level: Level, event: string, message: string, meta?: Record<string, any>, context?: Record<string, any>): LogLine {
  return {
...
export async function logInfo (event: string, message: string, meta?: Record<string, any>, context?: Record<string, any>): Promise<void> {
  await writeLine(baseLine('info', event, message, meta, context))
}

export async function logWarn (event: string, message: string, meta?: Record<string, any>, context?: Record<string, any>): Promise<void> {
  await writeLine(baseLine('warn', event, message, meta, context))
}

export async function logError (event: string, message: string, meta?: Record<string, any>, context?: Record<string, any>): Promise<void> {
