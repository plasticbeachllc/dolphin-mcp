...
import { fetchSnippetsInParallel, requestsFromHits, type SnippetFetchRequest, type SnippetFetchResult } from '../mcp/tools/snippet_fetcher.js'
...
describe('snippet_fetcher', () => {
  describe('fetchSnippetsInParallel', () => {
    ...
    it('handles timeout scenarios', async () => {
      ...
      const failedCount = Object.values(results).filter(r => r?.warnings?.includes('Failed to load snippet')).length
